...
Порядок полей совпадает с порядком в движке: поля профиля, правила и
функции идут в одном порядке. Расхождение схемы и движка — это ошибка, а не
...
# нет, он на ответ не влияет. Границы баллов те же, что в js/lib/limits.js.
